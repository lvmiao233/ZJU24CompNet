...
description: 介绍 Angular 风格的 Git Commit 消息规范，包括其重要性、格式要求（Header、Body、Footer）和实际应用示例，旨在提升协作效率和自动化流程。
---
...
![常见Commit Type](img\65e5572e51088274339ce8d7)

确定所属type方式：

![确定Commit所属Type方式](img\65e5572e51088274339ce8d8)
