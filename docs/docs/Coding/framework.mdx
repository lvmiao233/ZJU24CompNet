...
我们的测试框架使用Python编写，在Python3.10+进行了测试，根据依赖包/特性需求，本地测试框架至少需要Python3.6+，在线测试版本至少需要Python2.7+ / 3.4+，如果你尝试使用较老版本运行时出现问题，请先尝试更新/使用较新版本
...
我们的测试框架提供在线与本地测试两种版本：

* 在线版本

  使用Flask实现了测试服务端，运行后支持在实验文档网站内连接进行测试；该版本同时也作为目前主流Web服务端的简单DEMO，供你学习与参考

* 本地版本

  可直接本地发起测试，无需持续启用服务/网站内操作，仅展示测试结果
...
![image-20241013025133530](img/image-20241013025133530.png)
...
启动后，打开实验文档网址，填入测试服务地址/Socket服务端地址，并指定其他测试参数，点击发起测试进行测试

![image-20241013025813724](img/image-20241013025813724.png)

测试完成后，将会显示测试结果，你可以翻页对每个线程的结果进行查看

![image-20241013025922080](img/image-20241013025922080.png)
...
![image-20241013030052259](img/image-20241013030052259.png)
