...
<LinkCard title="编程实验测试框架" url="https://github.com/lvmiao233/NetLabFramework">
    {"计算机网络 Lab7-8 测试框架"}
</LinkCard>
...
* 直接安装Python3
  ...
  <LinkCard title="在Windows上使用Python" url="https://learn.microsoft.com/zh-cn/windows/python/beginners">
      {"Microsoft Learn"}
  </LinkCard>
...
* 安装Anaconda/MiniConda/Pixi等包/环境管理器
  ...
  <LinkCard title="Anaconda Documentation" url="https://docs.anaconda.com/distro-or-miniconda/">
