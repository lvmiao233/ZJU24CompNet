...
<ImageUploader questionId="lab1-ping-screenshot" />
...
**记录数据：** 使用的过滤器：<ModernInput questionId="lab1-filter-used-ip"/>，希望显示的协议类型：<ModernInput questionId="lab1-filter-ip-address"/>
...
**记录数据：** 使用的过滤器：<ModernInput questionId="lab1-task5-filter"/>，希望显示的协议类型：<ModernInput questionId="lab1-task5-protocol"/>
