...
* 点击配置与连接，创建新的串口连接标签页
   ...
   ![1760207841661](img/Terminal_Helper/1760207841661.png)
* 点击所需的串口，如果找不到，请直接输入`COM{串口号}`，如`COM6`
  
   ![1760207867255](img/Terminal_Helper/1760207867255.png)
* 选择波特率，一般请选择9600
  
   ![1760207917615](img/Terminal_Helper/1760207917615.png)
