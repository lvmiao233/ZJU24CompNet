...
import { taskColumns } from "@site/src/components/CourseWorkTable";


## 建议提交时间

<Alert message="所有的实验报告最晚需在12月29日前提交到作业系统，逾期提交的任何内容均不计入最终成绩考核。" type="warning" showIcon/>
<br/>
<Table columns={taskColumns} dataSource={LabDeadlineData} pagination={false} size={'small'}/>
