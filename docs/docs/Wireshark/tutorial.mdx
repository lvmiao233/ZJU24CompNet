...
![Wireshark软件界面截图](img/image-20240907094430591.png)
...
* 启动Wireshark后，首页会展示可捕获的网络接口列表，右侧折线表示相应设备的网络活动流量
  ...
  ![Wireshark网络接口选择界面](img/image-20240907002402646.png)

* 开始捕获后，可点击工具栏上的红色按钮停止抓包，绿色鲨鱼鳍按钮重新开始对当前选定NIC的抓包

  ![Wireshark抓包控制按钮界面](img/image-20240907002743240.png)

* 停止抓包后，可点选文件-保存，将抓包得到的数据保存供后续使用

  ![Wireshark文件保存对话框](img/image-20240907002945420.png)



## 2 Wireshark 功能与界面介绍

![Wireshark主界面功能区域说明](img/1725640544121.jpg)
