---
sidebar_position: 2
title: Lab2 使用二层交换机组网 精简版
description: 计算机网络实验二（Lab2）使用二层交换机组网的精简版指导，旨在帮助学生掌握交换机工作原理、VLAN 配置、Trunk 链路及冗余备份。文档包含实验目的、内容、所需设备和 IOS 基本操作命令。
---
