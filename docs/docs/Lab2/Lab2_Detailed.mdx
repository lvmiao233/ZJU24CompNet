...
<ModernInput size="exlarge" questionId="lab2-question"/>

在实验过程中你可能会遇到的困难，并得到了宝贵的经验教训，请把它们记录下来，提供给其他人参考吧：

<ModernInput size="exlarge" questionId="lab2-experience"/>

你对本实验安排有哪些更好的建议呢？欢迎献计献策：

<ModernInput size="exlarge" questionId="lab2-suggestion"/>
