...
<GridContainer>
    ...
    <FileCard file_type={'pdf'} name={'Lab6 动态路由协议BGP配置 实验课件（原理）'} size={'2264528'} link={require('@site/assets/slides/Lab6 动态路由BGP协议.pdf').default} />
...
| **站点本地 (Site-Local)** | `FC00::/7` | 私网IP | 类似于IPv4的私网地址，现在已被IETF废弃，由ULA取代 |
