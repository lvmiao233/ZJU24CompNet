...
<ScreenshotCard 
  ...
  title="R3配置命令" 
  uploadOptions={[
    { id: 'r3_config', label: '记录R3配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 10} }
  ]}
>
   ```kotlin
...
<ScreenshotCard 
  questionId="Lab6-p1-s2-r4" 
  title="R4配置命令" 
  uploadOptions={[
    { id: 'r4_config', label: '记录R4配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 10} }
  ]}
>
   ```
...
<ScreenshotCard 
  questionId="Lab6-p1-s2-r5" 
  title="R5配置命令" 
  uploadOptions={[
    { id: 'r5_config', label: '记录R5配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 10} }
  ]}
>
   ```kotlin
   R5(config)#interface f0/1
...
<ScreenshotCard 
  questionId="Lab6-p1-s4-r3" 
  title="R3配置命令" 
  uploadOptions={[
    { id: 'r3_bgp_config', label: '截图R3 BGP配置命令' }
  ]}
>
   ![](img/image5.png)
</ScreenshotCard>
...
<ScreenshotCard 
  questionId="Lab6-p1-s4-r5" 
  title="R5配置命令" 
  uploadOptions={[
    { id: 'r5_bgp_config', label: '记录R5 BGP配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 4} }
  ]}
>
   ```kotlin
   R5(config)#
...
<ScreenshotCard 
  questionId="Lab6-p1-s6-r3cmd" 
  title="R3配置命令" 
  uploadOptions={[
    { id: 'r3_update_source', label: '截图R3配置命令' }
  ]}
>
   ![](img/image8.png)
</ScreenshotCard>
...
<ScreenshotCard 
  questionId="Lab6-p1-s6-r5cmd" 
  title="R5配置命令" 
  uploadOptions={[
    { id: 'r5_update_source', label: '记录R5配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} }
  ]}
>
   ```kotlin
   R5(config)#
...
<ScreenshotCard 
  questionId="Lab6-p1-s6-r3nb" 
  title="R3的邻居关系" 
  uploadOptions={[
    { id: 'r3_neighbor_established', label: '截图R3邻居关系' }
  ]}
>
   R3的邻居关系（选取关键信息进行截图）：观察得知，与R5的邻居关系已经建立，对方的连接端口是<ModernInput size="medium" questionId="Lab6-p1-s6-r3-port"/>。
...
<ScreenshotCard 
  questionId="Lab6-p1-s6-r5nb" 
  title="R5的邻居关系" 
  uploadOptions={[
    { id: 'r5_neighbor_established', label: '截图R5邻居关系' }
  ]}
>
   R5的邻居关系（选取关键信息进行截图）：观察得知，与R3的邻居关系已经建立，对方的连接端口是<ModernInput size="medium" questionId="Lab6-p1-s6-r5-port"/>。
</ScreenshotCard>
...
<ScreenshotCard 
  questionId="Lab6-p2-s8-r2" 
  title="R2配置命令" 
  uploadOptions={[
    { id: 'r2_config', label: '记录R2配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 11} }
  ]}
>
   ```kotlin
...
<ScreenshotCard 
  questionId="Lab6-p2-s8-r6" 
  title="R6配置命令" 
  uploadOptions={[
    { id: 'r6_config', label: '记录R6配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 11} }
  ]}
>
   ```kotlin
...
<ScreenshotCard 
  questionId="Lab6-p2-s8-r7" 
  title="R7配置命令" 
  uploadOptions={[
    { id: 'r7_config', label: '记录R7配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 11} }
  ]}
>
   ```kotlin
...
<ScreenshotCard 
  questionId="Lab6-p2-s8-r8" 
  title="R8配置命令" 
  uploadOptions={[
    { id: 'r8_config', label: '记录R8配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 11} }
  ]}
>
   ```kotlin
...
<ScreenshotCard 
  ...
  title="配置命令" 
  uploadOptions={[
    { id: 'r3_ebgp_config', label: '记录R3配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} },
    { id: 'r5_ebgp_config', label: '记录R5配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} }
  ]}
>
   R3的配置命令：
...
<ScreenshotCard 
  questionId="Lab6-p2-s10-r1" 
  title="R1的邻居关系" 
  uploadOptions={[
    { id: 'r1_neighbor', label: '截图R1邻居关系' }
  ]}
>
...
<ScreenshotCard 
  questionId="Lab6-p2-s10-r3" 
  title="R3的邻居关系" 
  uploadOptions={[
    { id: 'r3_neighbor', label: '截图R3邻居关系' }
  ]}
>
    R3的邻居关系：R3的iGP邻居的IP为<ModernInput size="large" questionId="Lab6-p2-s10-r3-igp"/>，eBGP邻居的IP为<ModernInput size="large" questionId="Lab6-p2-s10-r3-ebgp"/>。
...
<ScreenshotCard 
  questionId="Lab6-p2-s10-r5" 
  title="R5的邻居关系" 
  uploadOptions={[
    { id: 'r5_neighbor', label: '截图R5邻居关系' }
  ]}
>
    R5的邻居关系：R3的iGP邻居的IP为为<ModernInput size="large" questionId="Lab6-p2-s10-r5-igp"/>，eBGP邻居的IP为为<ModernInput size="large" questionId="Lab6-p2-s10-r5-ebgp"/>。
</ScreenshotCard>

<ScreenshotCard 
  questionId="Lab6-p2-s10-r6" 
  title="R6的邻居关系" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab6-p3-s18-config" 
  title="配置命令" 
  uploadOptions={[
    { id: 'r3_sync_config', label: '记录R3配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} },
    { id: 'r5_sync_config', label: '记录R5配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} }
  ]}
>
    R3的配置命令：
...
<ScreenshotCard 
  questionId="Lab6-p3-s18-r1" 
  title="R1的BGP数据库及测试结果" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab6-p3-s19-config" 
  title="配置命令" 
  uploadOptions={[
    { id: 'r3_redist_config', label: '记录R3配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} },
    { id: 'r5_redist_config', label: '记录R5配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} }
  ]}
>
    R3的配置命令：
...
<ScreenshotCard 
  questionId="Lab6-p3-s21-config" 
  title="R3配置命令" 
  uploadOptions={[
    { id: 'r3_bgp_redist_config', label: '记录R3配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} }
  ]}
>
    ```kotlin
    R3(config)#
...
<ScreenshotCard 
  ...
  title="配置命令" 
  uploadOptions={[
    { id: 'r1_pc_config', label: '记录R1配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 5} },
    { id: 'pc1_config', label: '记录PC1配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 1} }
  ]}
>
    R1的配置命令：
...
<ScreenshotCard 
  questionId="Lab6-p3-s23-config" 
  title="配置命令" 
  uploadOptions={[
    { id: 'r2_pc_config', label: '记录R2配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 5} },
    { id: 'pc3_config', label: '记录PC3配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 1} }
  ]}
>
    R2的配置命令：
...
<ScreenshotCard 
  questionId="Lab6-p5-s26-config" 
  title="R1配置命令" 
  uploadOptions={[
    { id: 'r1_ipv6_config', label: '记录R1配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 8} }
  ]}
>
...
<ScreenshotCard 
  questionId="Lab6-p5-s27-config" 
  title="R6配置命令" 
  uploadOptions={[
    { id: 'r6_ipv6_config', label: '记录R6配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 5} }
  ]}
>
    ```kotlin
    R6(config)#interface f2/0
...
<ScreenshotCard 
  questionId="Lab6-p5-s27-if" 
  title="R6的IPv6接口和Ping测试" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab6-p5-s28-config" 
  title="配置命令" 
  uploadOptions={[
    { id: 'r1_ipv6_bgp_config', label: '截图R1配置命令' },
    { id: 'r6_ipv6_bgp_config', label: '记录R6配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 6} }
  ]}
>
    R1的配置命令：
...
<ScreenshotCard 
  questionId="Lab6-p5-s28-neighbor" 
  title="IPv6邻居信息" 
  uploadOptions={[
...
<ScreenshotCard 
  ...
  title="PC2配置和测试" 
  uploadOptions={[
    { id: 'pc2_ipv6_config', label: '记录PC2配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 2} },
...
<ScreenshotCard 
  ...
  title="PC5配置和测试" 
  uploadOptions={[
    { id: 'pc5_ipv6_config', label: '记录PC5配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 1} },
...
<ScreenshotCard 
  ...
  title="配置命令和测试结果" 
  uploadOptions={[
    { id: 'r2_ipv6_config', label: '记录R2配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 4} },
    { id: 'pc4_ipv6_config', label: '记录PC4配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 1} },
...
<ScreenshotCard 
  ...
  title="静态路由配置和测试" 
  uploadOptions={[
    { id: 'r1_ipv6_static', label: '截图R1静态路由配置' },
    { id: 'r2_ipv6_static', label: '记录R2静态路由配置', type: 'text', textConfig: {codeEditor: true, initialLines: 1} },
...
<ScreenshotCard 
  ...
  title="静态路由配置和测试" 
  uploadOptions={[
    { id: 'r2_pc5_static', label: '记录R2静态路由配置', type: 'text', textConfig: {codeEditor: true, initialLines: 1} },
