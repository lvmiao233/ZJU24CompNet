...
2.  给PC4配置IPv6地址
3.  用Ping测试PC4和R2的连通性
4.  用Ping测试PC4和PC2的连通性；观察可知，此时由于路由器<ModernInput size="medium" questionId="Lab6-p5-s32-router"/>没有<ModernInput size="large" questionId="Lab6-p5-s32-route"/>的IPv6路由，无法Ping通PC2
