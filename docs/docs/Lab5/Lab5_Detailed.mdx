...
<ScreenshotCard 
  questionId="Lab5-p1-s4-traceroute" 
  title="路由跟踪结果" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab5-p2-s10-routing" 
  title="路由器路由表" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab5-p2-s10-traceroute" 
  title="路由跟踪结果" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab5-p3-s15-routing" 
  title="区域间路由表" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab5-p3-s21-test" 
  title="Frame Relay映射和连通性测试" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab5-p3-s24-neighbor" 
  title="邻居关系查看（配置后）" 
  uploadOptions={[
...
<ScreenshotCard 
  questionId="Lab5-p3-s29-neighbor" 
  title="邻居关系查看" 
  uploadOptions={[
...
<ScreenshotCard 
  ...
  title="R10路由表和OSPF数据库" 
  uploadOptions={[
    { id: 'r10_route_after_vlink', label: '截图R10路由表' },
