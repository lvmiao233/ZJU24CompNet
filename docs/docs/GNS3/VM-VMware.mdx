...
<Tabs className="unique-tabs"  groupId="platform">
    ...
    <TabItem value="macOS (Apple Silicon)">
        <Row gutter={[16, 4]} justify="space-between">
            <Col xs={24} sm={12}>
                <FileCard link="https://pan.zju.edu.cn/share/72fba75eb23559b779c47f5ec9" name="浙大云盘" size={909808022} file_type="cloud"/>
            </Col>
            <Col xs={24} sm={12}>
...
<Tabs className="unique-tabs"  groupId="operating-systems">
    ...
    <TabItem value="macOS">
        ...
        * 点击添加设备，选择网络适配器，选择桥接模式，选择Wifi
            ...
            ![image-20241029131333885](img/image-20241029131333885.png)
