...
如果你不确定自己在做什么（并不是必须使用GNS3 VM的Hyper-V版本，或你完全不了解Hyper-V），**不要按照本页面操作**，请阅读：[Vmware Workstation虚拟机配置](/docs/GNS3/VM-VMware)，文档中新的连接方式已经解决了过往强制虚拟化造成的问题，推荐你选择使用VMware Workstation运行GNS3虚拟机
...
* 下载GNS3 VM 3.0.0rc1（或更新版本）
  ...
  :::important 旧版Hyper-V GNS3 VM对网络适配器切换支持不佳，建议选择较新的、与客户端版本匹配的VM
  :::
...
* 运行完成后，打开Hyper-V管理器（可Win+S打开Windows搜索，搜索“Hyper-V”找到）
  ...
  <img src={require('./img/image-20240828122511513.png').default}   alt="image-20240828122511513" style={{zoom:'80%'}} />
...
* 再次选中GNS3 VM，右键-设置，选择添加硬件-网络适配器-添加
  ...
  <img src={require('./img/image-20231107190852270.png').default}   alt="image-20231107190852270" style={{zoom:'90%'}} />

* 指定我们刚刚添加好的虚拟网络交换机并应用

    <img src={require('./img/image-20231107190934640.png').default}   alt="image-20231107190934640" style={{zoom:'90%'}} />
...
* 无法Ping通虚拟机内网络设备
  ...
  <img src={require('./img/image-20231107204429414.png').default}   alt="image-20231107204429414" style={{zoom:'80%'}} />
