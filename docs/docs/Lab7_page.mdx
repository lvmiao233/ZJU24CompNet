...
<DeadlineProcess start={'2025-09-28 18:50:00'} end={'2025-12-30 23:59:59'}/>
<GridContainer>
...
<MultiTestCard header={"测试1 服务端连接与发送测试"} testUri={"/test/lab7/standalone"}/>
...
<MultiTestCard header={"测试3 服务端多线程测试"} testUri={"/test/lab7/threaded"} multiThread/>
