...
import HTTPVersions, {HTTPMethods} from '@site/src/compData/HTTPInfo.js';
...
在这一部分，我们将带你了解HTTP相关的基本概念，你可以边学习边打开开发者工具（Ctrl + Shift + J 或 F12）动手尝试
...
<MappedCollapse items={HTTPVersions} defaultActiveKey={['HTTP/1.0']} />
...
<MappedCollapse items={HTTPMethods} defaultActiveKey={['GET方法']} />
<br/>
