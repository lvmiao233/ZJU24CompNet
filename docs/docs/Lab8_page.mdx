...
<img alt={"image-20241028145513246"} src={require('./img/Lab8/image-20241028145513246.png').default} style={{zoom: '60%'}}/>
...
<img src={require("./img/Lab8/image-20241029214851758.png").default} alt="image-20241104014315752" style={{zoom: "55%"}} />
