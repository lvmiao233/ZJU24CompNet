...
import HTTPVersions, {HTTPMethods, HTTPMethodsExtras, cacheAttrInfo, cacheAttrExtra, negotiationAttrInfo, negotiationAttrExtra, resourceAttrInfo, resourceAttrExtra, securityAttrInfo, securityAttrExtra, uriMap, uriMapColumn, responseCode, responseCodeColumn,  HTTPMethodAttribute,  HTTPMethodAttributeColumn} from '@site/src/compData/HTTPInfo.js';
