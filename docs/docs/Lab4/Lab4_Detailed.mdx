...
<ScreenshotCard 
  questionId="Lab4-p1-s25" 
  title="NAT配置命令" 
  uploadOptions={[
    { id: 'nat_config', label: '记录配置命令', type: 'text', textConfig: {codeEditor: true, initialLines: 8} }
  ]}
>
  ```kotlin
