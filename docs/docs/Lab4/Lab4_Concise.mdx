...
<iframe src={require('@site/assets/slides/Lab4-静态路由配置.pdf').default} frameborder="0" width="960" height="749" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
## 二、实验内容
