...
<FileCard file_type={'doc'} name={'Lab6 实验报告模板 Word版本'} size={'1111552'} link={'http://10.214.0.253/network/download/Assignments/FundOfNetworks/2018/%e5%ae%9e%e9%aa%8c%e6%8a%a5%e5%91%8a%e6%a8%a1%e7%89%88_%e5%ae%9e%e9%aa%8c6.doc'} />
