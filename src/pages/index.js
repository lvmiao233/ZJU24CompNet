          ...
          <div className="container">
            <div className="row">
              <div>
                ...
                <br />
                <br />
                <h3 style={{ color: '#006d75' }}>预修要求</h3>
                具有编程基础，最好是熟练掌握C语言；学习了数据结构、计算机组成、操作系统、汇编语言等课程；能够用高级程序设计语言和汇编语言进行程序设计；掌握计算机硬件工作原理，对CPU、存储器、I/O系统、中断等有全面的了解。
                <br />
                <br />
                <h3 style={{ color: '#006d75' }}>考核形式</h3>
                <h4>作业：</h4>
                <br />
                <h4>测验：</h4>
                <br />
