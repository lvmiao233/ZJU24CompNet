    ...
    return (<Layout
        ...
        <div className="container">
            <div style={{ margin: isMobile ? '48px 16px' : '48px 48px' }}>
                <Alert title={<>如需访问实验文档正文内容，请点击左上方Tab-实验指导 或 <Link href="/docs/intro/">点我进行跳转</Link> </>} type="info" showIcon style={{ marginBottom: 8 }} />
                ...
                <br /> <br />
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(435px, 1fr))', gap: '16px' }}>
                    <div>
