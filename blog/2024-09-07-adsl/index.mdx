...
![弱电误接 220V 的危险接线示意图（以太网线接入市电）](img/220oe)
...
![Windows 设置：网络和 Internet 设置入口截图（任务栏网络图标）](img/image-20240907223346873.png)

* Windows11 用户

  点选高级网络设置，并点选禁用无线网卡

  ![Windows 11 高级网络设置界面截图（禁用无线网卡）](img/image-20240907223442871.png)

* Windows10 用户

  点选右侧更改适配器选项，打开适配器列表

  ![Windows 10 网络适配器设置入口截图（更改适配器选项）](img/202203311648713572563867.jpg)

  右键点击无线网卡，选择禁用

  ![Windows 10 禁用无线网卡操作截图（右键适配器并禁用）](img/202203311648713572376578.jpg)
...
* 查看Wireshark捕捉到的ppp协议数据包
  ...
  ![Wireshark 抓取 PPPoE 认证信息截图（显示账号与密码字段）](img/image-20240907223945421.png)
